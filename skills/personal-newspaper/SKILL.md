...
2. Follow the research, preference, evidence, editorial, canonical-copy, image, and page-composition gates in [the publication pipeline](references/pipeline.md). Write a draft matching `assets/edition-template.json`; omit `generation`.
